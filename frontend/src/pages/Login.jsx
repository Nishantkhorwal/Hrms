        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setFormData((prev) => ({
                  ...prev,
                  role: value,
                  site: value === "User" ? prev.site : "", // ✅ Clear site if Admin or SuperAdmin
                }));
            ...
            >
              ...
              <option value="SuperAdmin">SuperAdmin</option> {/* ✅ NEW */}
            </select>
          </div>


{/* ✅ Site Field — Only show when role = User */}
{formData.role === "User" && (
  <div>
    <label
      htmlFor="site"
    ...
    <select
      ...
      required={formData.role === "User"} // ✅ only required for users
      className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 focus:ring-2 focus:ring-blue-500"
    >
